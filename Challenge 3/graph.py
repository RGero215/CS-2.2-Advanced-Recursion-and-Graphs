...
class Graph:
    ...
    def read_graph_from_file(self, file_name):
        ...
        print("check valid types:", file_list[0].rstrip() in valid_types)
        print('from file type is:', file_list[0].rstrip())
        ...
        print('Checks if type is :', graph_type == 'D')
        if graph_type == 'D':
            directed = True
            print("##### Type: ", directed)
...
if __name__ == "__main__":
    ...
    print(eduardo.get_neighbors())
    print(junior.get_neighbors())
    print(graph.depth_first_search('Eduardo Geronimo', 'Joel Pichardo'))
